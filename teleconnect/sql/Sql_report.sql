...
-- Create a detailed call-level performance report with timestamps, duration, revenue, signal, and validation info
...
SELECT
    ...
    TO_CHAR(call_timestamp, 'Day') AS day_of_week,
    ...
    data_usage_mb,
    revenue_naira,
    revenue_naira / NULLIF(call_duration_seconds, 0) AS revenue_per_call,
